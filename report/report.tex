...
\begin{abstract}
    ...
    limited to a restricted number of labs with both the time and infrastructure
    ...
    intermediary made need to be materialized to shared storage for post-processing
    ...
    and a real neuroimaging application on the CoRR dataset using 25 and 96 parallel
    processes in both cases. It was found that performance of all available storage
