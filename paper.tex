...
Whereas operating systems (OS) and popular Big Data engines, such as MapReduce~\cite{mapreduce} and Apache Spark~\cite{spark}, have
...
\begin{subfigure}{\columnwidth}
        \centering
    \includegraphics[width=\columnwidth]{./experiments/bigbrain-incrementation/figures/stacked-real-spark_20bb_25cpus.pdf}
...
\begin{figure*}
    \begin{subfigure}{\columnwidth}
        \centering
    \includegraphics[width=\columnwidth]{./experiments/bigbrain-incrementation/figures/makespan-real-spark_20bb_96cpus.pdf}
    \caption{Makespan}\label{fig:20mkspspark96}
\end{subfigure}
\begin{subfigure}{\columnwidth}
        \centering
    \includegraphics[width=\columnwidth]{./experiments/bigbrain-incrementation/figures/stacked-real-spark_20bb_96cpus.pdf}
...
high-quality technical support, and, in  particular, Steve Scargall, for
providing thorough technical support on the manuscript.
